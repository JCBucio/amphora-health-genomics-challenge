...
# Function that receives a dataframe and a target column and returns the X and y train and test dataframes
...
def generate_model(X_train, y_train, pkl_file_path):
...
# Function to plot the validation and learning curve for a model
